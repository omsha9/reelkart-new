...
const Placeholder = ({ label = "", height = "140vh", width = "12vw", token }) => {
  const decoded = jwtDecode(token);
  const company_domain = decoded.dest.slice(8)
  console.log("Domain Name", company_domain)
        ...
        >
          ...
          >
            ...
            <span
              ...
              onMouseLeave={(e) => (e.target.style.textDecoration = "none")}
            >
              <a href={`https://dashboard.reelkart.io/myproducts?`+`${company_domain}`} target="_self">My product</a>
              {/* <Link  to={{ pathname: "dashboard.reelkart.io" }} target="_self"> 
                My Product
               </Link> */}
            </span>
          </div>
